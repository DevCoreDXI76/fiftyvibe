    ...
    <div className="mx-auto flex max-w-3xl flex-col gap-10 px-6 py-12">
      ...
      <section className="flex flex-col gap-4 text-navy">
        ...
        <p>
          ...
          퇴직급여만 비교합니다. 다만 실제 전환 시에는 이미 근무한 기간에
          대한 DB 권리도 전환 시점의 임금 수준으로 함께 정산됩니다 — 즉,
          임금피크제가 이미 적용된 뒤에 전환하면 과거 근속분까지 낮아진
          임금 기준으로 정산되어 불리해질 수 있습니다. 이것이 많은 분들이
          임금피크제 적용 전에 DC 전환을 서두르는 이유 중 하나이며, 이
          계산기의 결과에는 반영되지 않은 부분이니 참고하시기 바랍니다.
        </p>
      </section>
