...
- [x] 1차 심사 결과: **거절** (08-12, 사유 "가치가 별로 없는 콘텐츠" — 소유권 확인 통과,
  다른 정책 위반 없음. 대응: 3주 보강 후 재신청 트랙, 재신청 목표 8/30~9/5. **그 전까지
  "검토 요청" 버튼 금지**)
- [x] 재신청 보강 1주차: 도구 3페이지 본문 증량(각 해설+실계산 예시 표+FAQ 7~9개) + About
  확장 + ToolGuide 컴포넌트/FAQPage JSON-LD (08-12, TASK_adsense-week1 T1~T6, 커밋 8건)
- [x] 1주차 배포 후 처리 (08-13, 운영자): Vercel 배포 확인, 서치콘솔 색인 재요청 4 URL
  (도구 3 + about), FAQPage 마크업 검증 — 리치 결과 테스트는 FAQ 감지가 제거되어(구글
